<?php 
    ...
    if (isset($_POST['signup'])) {
        ...
        if (empty($firstname)) {
            ...
            $_SESSION['error'] = 'กรุณากรอก lineID';
            header("location: index.php");
        } else if (empty($phone)) {
            ...
            try {
                ...
                if ($row['email'] == $email) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO users(firstname, lastname, username, lineID, phone, email, password, urole) 
                                            VALUES(:firstname, :lastname, :username, :lineID, :phone, :email, :password, :urole)");
